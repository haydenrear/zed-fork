...
use language_model::{
    _retrieve_ids, AuthenticateError, EnvVar, IconOrSvg, LanguageModel,
    LanguageModelCacheConfiguration, LanguageModelCompletionError, LanguageModelCompletionEvent,
    LanguageModelId, LanguageModelName, LanguageModelProvider, LanguageModelProviderId,
    LanguageModelProviderName, LanguageModelProviderState, LanguageModelRequest,
    LanguageModelToolChoice, LanguageModelToolResultContent, LanguageModelToolUse, MessageContent,
    RateLimiter, Role, TokenUsage, env_var, get_message_handler_async,
};
...
impl LanguageModel for BedrockModel {
    ...
    > {
        ...
        let future = self.request_limiter.stream(async move {
            ...
            let stream = if deny_tool_calls {
                deny_tool_use_events(events).boxed()
            } else {
                events.boxed()
            };
            Ok(peek_db(
