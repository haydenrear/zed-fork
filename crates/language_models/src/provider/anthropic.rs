...
use language_model::message_handler::{
    AiMessageHandler, LanguageModelArgs, get_message_handler, peek_db,
};
use language_model::{
    _retrieve_ids, ApiKeyState, AuthenticateError, ConfigurationViewTargetAgent, EnvVar, IconOrSvg,
    LanguageModel, LanguageModelCacheConfiguration, LanguageModelCompletionError,
    LanguageModelCompletionEvent, LanguageModelId, LanguageModelName, LanguageModelProvider,
    LanguageModelProviderId, LanguageModelProviderName, LanguageModelProviderState,
    LanguageModelRequest, LanguageModelToolChoice, LanguageModelToolResultContent,
    LanguageModelToolUse, MessageContent, RateLimiter, Role, StopReason, env_var,
};
...
impl LanguageModel for AnthropicModel {
    ...
    > {
        ...
        let message_handler = cx.update(|cx| get_message_handler(cx));
